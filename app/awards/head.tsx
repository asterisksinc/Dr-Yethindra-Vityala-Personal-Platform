export default function Head() {
  return (
    <>
      ...
      <meta
        name="description"
        content="Dr. Yethindra Vityala's 12 world records (Guinness, WRCA) & 25+ awards: Youngest Scientist in Medicine, Karmaveer Chakra UN, MedEngage Champion. View certifications."
      />
      <meta
        name="keywords"
