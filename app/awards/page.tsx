  ...
  return (
    ...
    <section className="vit-awards-wrapper w-full p-2 md:p-2.5 lg:p-3 flex flex-col gap-2 pb-10 md:pb-6 lg:pb-3 lg:h-[calc(100vh-80px)] overflow-y-auto lg:overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-3 min-h-0">
        ...
        <div className="w-full md:w-[65%] lg:w-[66.666%] h-[400px] sm:h-[200px] md:h-[220px] lg:h-full bg-[#111] rounded-[24px] overflow-hidden shrink-0 flex flex-col sm:flex-row items-center justify-between p-4 sm:p-5 lg:p-5 gap-3">            <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="w-36 h-36 sm:w-32 sm:h-32 md:w-40 md:h-40 guinness-img-lg relative shrink-0">
              <Image
                src="/guinness.png"
    ...
    <div className="bg-[#FFFFFF] rounded-[16px] p-2.5 sm:p-3 shadow-sm flex gap-2 sm:gap-3 items-start border border-gray-100 hover:shadow-md transition-shadow shrink-0">
      <div className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 flex items-center justify-center shrink-0 mt-0.5">
        <Image
          ...
          width={112}
          height={112}
          className="h-3 w-3 sm:h-7 sm:w-7 lg:h-8 lg:w-8 object-contain"
        />
      </div>
