      ...
      <div className="bg-[#FFFFFF] rounded-[16px] p-2 sm:p-3 lg:p-4 shadow-sm border border-gray-100 flex flex-col gap-2">
       <div className="px-1 mt-2 md:mt-0 mb-2 sm:mb-3">
        ...
        {items.map((item) => (
          <div
            key={item.id}
            className="bg-[#f5f5f5] rounded-[12px] px-3 py-3 flex flex-col md:flex-row md:items-center gap-2 md:gap-3 h-auto md:h-auto lg:h-[120px]"
          >
            {/* Title + Subtitle */}
            <div className="flex flex-col w-full md:w-[35%] pr-2">
              ...
              <span className="text-[#999] text-[12px] sm:text-[13px] lg:text-[14px] mt-0.5 sm:mt-1 font-light">
                {item.subtitle}
              </span>
            </div>
            ...
            <div className="w-full md:w-[22%] pr-2">
              <span className="text-[#555] text-[12px] sm:text-[13px] lg:text-[14px]">
                {item.location}
              </span>
            </div>
